...
class InvoiceExtractor:
    ...
    def __init__(self, xml_file):
        ...
        # --- NUEVO: convertimos a texto y lo imprimimos ---
        #xml_str = ET.tostring(self.root, encoding='unicode')
        #print("\n=== CONTENIDO COMPLETO DEL XML ===\n")
        #print(xml_str)
        #print("\n=== FIN DEL XML ===\n")
        # -------------------------------------
...
#Instancia
# invoice_extractor = InvoiceExtractor('./20601460913-01-F001-00002471.xml')
# invoice_extractor.extract_data()

# registration_name, num_coti, detalles = invoice_extractor.get_data()
