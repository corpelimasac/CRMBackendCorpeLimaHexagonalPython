from sqlalchemy import Column, Integer, VARCHAR, Date, BIT, ForeignKey
from datetime import datetime
from .base import Base

class ProductosModel(Base):
  __tablename__ = "productos"
  id_producto= Column(Integer, primaryKey=True, index=True, autoincrement=True, nullable=False)
  ...
  descontinuado = Column(BIT, default=True, nullable=True)
