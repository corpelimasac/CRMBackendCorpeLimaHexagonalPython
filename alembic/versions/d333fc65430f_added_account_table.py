...
Revision ID: d333fc65430f
Revises: 
Create Date: 2025-06-27 09:46:53.479158
...
def upgrade() -> None:
    ...
    op.add_column('ordenes_compra', sa.Column('correlative', sa.String(length=20), nullable=True))
...
def downgrade() -> None:
    ...
    op.alter_column('proveedor_contactos', 'sexo',
               existing_type=mysql.VARCHAR(length=255),
               nullable=False)
